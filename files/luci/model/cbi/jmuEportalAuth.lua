...
o = m:section(TypedSection, "jmuEportalAuth", translate("Settings"))
o.addremove = false
o.addremove = true
...
services = o:option(ListValue, "services", translate("Services"), translate("Bind network operator at <a href='http://user.jmu.edu.cn'>user.jmu.edu.cn</a> before using it."))
